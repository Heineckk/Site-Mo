      ...
      >
        <motion.div className="border-b border-white/10 p-6">
          ...
          <p className="mt-2 text-sm text-white/45">
            Toque no botão abaixo para enviar o pedido pelo WhatsApp. Fotos, se
            houver, mande em mensagem separada.
          </p>
        </motion.div>
        ...
        <motion.div className="border-t border-white/10 p-4">
          <a
            ...
            className="flex items-center justify-center gap-2 rounded-full bg-[#25D366] py-3 text-sm font-medium tracking-wider text-white transition hover:bg-[#20bd5a]"
          >
